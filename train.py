...
print("[INFO] TensorFlow version used for training:", tf.__version__)
...
if __name__ == "__main__":
    tickers = ["CC=F", "GC=F", "KC=F", "NG=F", "^GDAXI", "^HSI", "USD/JPY", "ETHUSD", "SOLUSD", "^SPX", "HG=F", "SI=F", "CL=F"]
    ...
    for ticker in tickers:
        ...
        if ode_func is not None:
            torch.save(ode_func.state_dict(), "model/neural_ode_func.pth")
